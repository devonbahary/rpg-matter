...
export default {
    ...
    WILD_SWING: {
        1: [ stepLock(true), STEP_BACKWARD, TURN_90D_L, weaponPose(WEAPON_POSES.EXTEND), animationSelf(33, true), playSe('Wind7', 90, 50), DIR_FIX_ON ],
        6: [ DIR_FIX_OFF, TURN_90D_R, weaponPose(WEAPON_POSES.EXTEND), DIR_FIX_ON ],
        7: APPLY_EFFECT,
